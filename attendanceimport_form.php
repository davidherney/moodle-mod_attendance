...
class mod_attendance_attendanceimport_form extends moodleform {
    ...
    public function definition() {
        ...
        $importandcontinuestring = get_string('importandcontinue', 'attendance');
        $buttonarray=array();
        $buttonarray[] = &$mform->createElement('submit', 'submitbutton', $submitstring);
        $buttonarray[] = &$mform->createElement('submit', 'submitandcontinuebutton', $importandcontinuestring);
    ...
    function definition_after_data() {
        ...
        if ($mform->elementExists('userslist')) {
            $userslist =& $mform->getElement('userslist');
            $userslist->setValue('');
        }
